...
import AñadirMisionero from "../components/AñadirMisionero";
import DefaultLayoutGrupo from "../components/DefaultLayoutGrupo";
  ...
  return (
    <div className="">
      ...
      <ModalContainer visible={viewTable} onClose={handleOnClose}>
        <AñadirMisionero visible={viewTable} onClose={handleOnClose} />
      </ModalContainer>
    </div>
  );
}
